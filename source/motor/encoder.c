...
void Encoder_StatusPrintTask(void)
{
    ...
    char mit_vel_x10[12];
    char mit_tau_ff_mnm[12];
    char mit_tau_static_mnm[12];
    char mit_tau_out_mnm[12];
    char mit_tau_motor_mnm[12];
    char ref_iq_ma[12];
    char id_ma[12];
    char iq_ma[12];
    char vd_x10000[12];
    ...
    (void)App_I32ToDecStr(mit_vel_x10, control_debug.mit_velocity_final_deg_s * 10);
    (void)App_I32ToDecStr(mit_tau_ff_mnm, (int32_t)(control_debug.mit_tau_ff_nm * 1000.0f));
    (void)App_I32ToDecStr(mit_tau_static_mnm, (int32_t)(control_debug.mit_tau_static_nm * 1000.0f));
    (void)App_I32ToDecStr(mit_tau_out_mnm, (int32_t)(control_debug.mit_tau_out_ref_nm * 1000.0f));
    (void)App_I32ToDecStr(mit_tau_motor_mnm, (int32_t)(control_debug.mit_tau_motor_ref_nm * 1000.0f));
...
#define APPEND_STR(s) do { const char *p = (s); while (*p != '\0') { line[idx++] = *p++; } } while (0)
    ...
    APPEND_STR(", velX10=");
    APPEND_STR(vel_x10);
    APPEND_STR(", mitVelX10=");
    APPEND_STR(mit_vel_x10);
    APPEND_STR(", mitTauFFmNm=");
    APPEND_STR(mit_tau_ff_mnm);
    APPEND_STR(", mitTauStaticmNm=");
    APPEND_STR(mit_tau_static_mnm);
    APPEND_STR(", mitTauOutmNm=");
    APPEND_STR(mit_tau_out_mnm);
    APPEND_STR(", mitTauMotormNm=");
    APPEND_STR(mit_tau_motor_mnm);
    APPEND_STR(", refIqMA=");
